...
goog.exportSymbol('proto.Osmosis.UpdateBody', null, global);
  ...
  proto.Osmosis.PeerInfo.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        heartbeatkey: msg.getHeartbeatkey_asB64(),
        certfingerprint: msg.getCertfingerprint_asB64(),
      };
...
proto.Osmosis.PeerInfo.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getHeartbeatkey_asU8();
  if (f.length > 0) {
...
/**
 * optional bytes heartbeatKey = 3;
 * @return {!(string|Uint8Array)}
 */
proto.Osmosis.PeerInfo.prototype.getHeartbeatkey = function () {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(
    this,
    3,
    ''
...
/**
 * optional bytes heartbeatKey = 3;
 * This is a type-conversion wrapper around `getHeartbeatkey()`
 * @return {string}
 */
proto.Osmosis.PeerInfo.prototype.getHeartbeatkey_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
 ...
 * @return {!Uint8Array}
 */
proto.Osmosis.PeerInfo.prototype.getHeartbeatkey_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
    this.getHeartbeatkey()
  ));
};
...
/** @param {!(string|Uint8Array)} value */
proto.Osmosis.PeerInfo.prototype.setHeartbeatkey = function (value) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.Osmosis.ConnectRequest.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ipaddress: jspb.Message.getFieldWithDefault(msg, 1, 0),
...
proto.Osmosis.ConnectResponse = function (opt_data) {
  jspb.Message.initialize(
    ...
    -1,
    null,
    proto.Osmosis.ConnectResponse.oneofGroups_
  );
};
 ...
 * @const
 */
proto.Osmosis.ConnectResponse.oneofGroups_ = [[1, 2]];

/**
 * @enum {number}
 */
proto.Osmosis.ConnectResponse.PayloadCase = {
  PAYLOAD_NOT_SET: 0,
  REQUEST: 1,
  ERROR: 2,
};
...
/**
 * @return {proto.Osmosis.ConnectResponse.PayloadCase}
 */
proto.Osmosis.ConnectResponse.prototype.getPayloadCase = function () {
  return /** @type {proto.Osmosis.ConnectResponse.PayloadCase} */ (jspb.Message.computeOneofCase(
    this,
    proto.Osmosis.ConnectResponse.oneofGroups_[0]
  ));
};
  ...
  proto.Osmosis.ConnectResponse.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        request:
          (f = msg.getRequest()) &&
          proto.Osmosis.ConnectRequest.toObject(includeInstance, f),
...
proto.Osmosis.ConnectResponse.deserializeBinaryFromReader = function (
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = new proto.Osmosis.ConnectRequest();
        reader.readMessage(
          value,
          proto.Osmosis.ConnectRequest.deserializeBinaryFromReader
        );
...
proto.Osmosis.ConnectResponse.serializeBinaryToWriter = function (
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.Osmosis.ConnectRequest.serializeBinaryToWriter
    );
  }
...
/**
 * optional ConnectRequest request = 1;
 * @return {?proto.Osmosis.ConnectRequest}
 */
proto.Osmosis.ConnectResponse.prototype.getRequest = function () {
  return /** @type{?proto.Osmosis.ConnectRequest} */ (jspb.Message.getWrapperField(
    this,
    proto.Osmosis.ConnectRequest,
    1
  ));
};

/** @param {?proto.Osmosis.ConnectRequest|undefined} value */
proto.Osmosis.ConnectResponse.prototype.setRequest = function (value) {
  jspb.Message.setOneofWrapperField(
    this,
    1,
    proto.Osmosis.ConnectResponse.oneofGroups_[0],
...
proto.Osmosis.ConnectResponse.prototype.clearRequest = function () {
 ...
 * @return {!boolean}
 */
proto.Osmosis.ConnectResponse.prototype.hasRequest = function () {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.Osmosis.ConnectResponse.prototype.getError = function () {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ''));
};

/** @param {string} value */
proto.Osmosis.ConnectResponse.prototype.setError = function (value) {
...
proto.Osmosis.ConnectResponse.prototype.clearError = function () {
  jspb.Message.setOneofField(
    this,
    2,
    proto.Osmosis.ConnectResponse.oneofGroups_[0],
 ...
 * @return {!boolean}
 */
proto.Osmosis.ConnectResponse.prototype.hasError = function () {
 ...
 * @constructor
 */
proto.Osmosis.UpdateBody = function (opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.Osmosis.UpdateBody, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.Osmosis.UpdateBody.displayName = 'proto.Osmosis.UpdateBody';
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.Osmosis.UpdateBody.prototype.toObject = function (opt_includeInstance) {
    return proto.Osmosis.UpdateBody.toObject(opt_includeInstance, this);
  };
   ...
   *     instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.Osmosis.UpdateBody} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.Osmosis.UpdateBody.toObject = function (includeInstance, msg) {
    var f,
      obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.Osmosis.UpdateBody}
 */
proto.Osmosis.UpdateBody.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Osmosis.UpdateBody();
  return proto.Osmosis.UpdateBody.deserializeBinaryFromReader(msg, reader);
};

/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Osmosis.UpdateBody} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Osmosis.UpdateBody}
 */
proto.Osmosis.UpdateBody.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.Osmosis.UpdateBody.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.Osmosis.UpdateBody.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Osmosis.UpdateBody} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Osmosis.UpdateBody.serializeBinaryToWriter = function (message, writer) {
  var f = undefined;
 ...
 * @return {!(string|Uint8Array)}
 */
proto.Osmosis.UpdateBody.prototype.getPayload = function () {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    ''
 ...
 * @return {string}
 */
proto.Osmosis.UpdateBody.prototype.getPayload_asB64 = function () {
 ...
 * @return {!Uint8Array}
 */
proto.Osmosis.UpdateBody.prototype.getPayload_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getPayload()));
};

/** @param {!(string|Uint8Array)} value */
proto.Osmosis.UpdateBody.prototype.setPayload = function (value) {
  jspb.Message.setProto3BytesField(this, 1, value);
};
